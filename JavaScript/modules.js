...
// to make it a JavaScript module we simply use the 'export' syntax
...
we use this method when we want to export only certain parts of a given JavaScript file. 
*/
