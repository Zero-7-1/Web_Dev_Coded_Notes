...
In the case of JavaScript, the source code is delivered to the browser, and the browser's JavaScript engine parses and executes the code on-the-fly. This process is known as interpretation. To be more specific modern browsers engines V8 of Chrome and SpiderMonkey use a combination of interpretation and compilation which is known as JIT (Just in Time) 
